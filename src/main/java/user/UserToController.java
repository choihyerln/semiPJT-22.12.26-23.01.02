...
public class UserController extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		case "delist":
			...
			rd = request.getRequestDispatcher("/ncpl/user/list.jsp");
			rd.forward(request, response);
			break;
		case "login":
			if (request.getMethod().equals("GET")) {
				rd = request.getRequestDispatcher("/ncpl/user/login.jsp");
				rd.forward(request, response);
			} else {
		...
		case "register":
			if (request.getMethod().equals("GET")) {
				rd = request.getRequestDispatcher("/ncpl/user/register.jsp");
				rd.forward(request, response);
			} else {
		...
		case "delete":
			uid = request.getParameter("uid");
			rd = request.getRequestDispatcher("/ncpl/user/delete.jsp?uid=" + uid);
			rd.forward(request, response);
			break;
		case "deleteConfirm":
			uid = request.getParameter("uid");
