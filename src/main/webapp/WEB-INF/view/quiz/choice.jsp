...
<body>
	...
	<div class="row row-cols-1 row-cols-md-2 g-4" style="margin:40px">
	<div class="col">
	...
	<div class="col">
		<div class="card">
		<img class="card-img-top" src="/ncpl/img/별자리 테스트_메인.jpeg" onclick="location.href='/ncpl/testForm/index';">
			<div class="card-body">
				 <h4 class="card-title">별자리 테스트</h4>
				 <p class="card-text">별자리로 알아보는 내 성격</p>
				 <a href="/ncpl/constellation/main" class="btn btn-primary">테스트 하러가기</a>
			</div>
		</div>
	</div>
    <br>
    ...
    <div class="col">
		<div class="card">
		<img class="card-img-top" src="/ncpl/img/팩폭력 테스트_메인.jpeg" onclick="javascript:location.href='/ncpl/testForm/index';">
			<div class="card-body">
