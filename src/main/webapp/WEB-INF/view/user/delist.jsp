	...
	<%@ include file="../common/top.jsp" %>
		...
		<div class="row">
			...
			<!-- =================== main =================== -->
                ...
                <hr>
                <!-- 프로필 이미지 -->
                <img src="/ncpl/img/pro.png" alt="profile" style="height:250px;" class="mx-auto d-block">
                <br>
                <c:forEach var="user" items="${userList}" varStatus="loop">
                	<!-- 수정 및 삭제 권한 -->
                    <span style="font-size: 1.0em;">                     
                        <c:if test="${uid eq user.uid}">
                        	<a href="/ncpl/user/update?uid=${user.uid}" class="ms-3"><i class="far fa-edit"></i>정보 수정</a><br>
                         </c:if>
                    </span>
                    <br>
                    <!-- 마이페이지 내 정보 -->                   
